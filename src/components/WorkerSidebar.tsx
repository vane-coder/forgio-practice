...
const items: Item[] = [
  { icon: "home-outline", label: "Dashboard", route: "/(worker)/home" },
  { icon: "cart-outline", label: "Marketplace", route: "/(worker)/marketplace" },
  { icon: "cube-outline", label: "Record materials", route: "/(worker)/record-material" },
  { icon: "clipboard-outline", label: "Enter production", route: "/(worker)/enter-production" },
  { icon: "cash-outline", label: "Goods sold", route: "/(worker)/record-sale" },
  { icon: "notifications-outline", label: "Notifications", route: "/(worker)/notifications" },
  { icon: "newspaper-outline", label: "News feed", route: "/(worker)/newsfeed" },
  { icon: "time-outline", label: "My records", route: "/(worker)/my-records" },
  { icon: "person-outline", label: "Profile", route: "/(worker)/profile" },
  { icon: "help-circle-outline", label: "Help & support", route: "/(worker)/help" },
];

export default function WorkerSidebar({ visible, onClose }: { visible: boolean; onClose: () => void }) {
