...
const items: Item[] = [
  { icon: "business-outline", label: "Warehouses", route: "/(manager)/branches" },
  { icon: "people-outline", label: "Manage workers", route: "/(manager)/permissions" },
  { icon: "cube-outline", label: "Materials", route: "/(manager)/materials" },
  { icon: "cash-outline", label: "Sales", route: "/(manager)/sales" },
  { icon: "notifications-outline", label: "Notifications", route: "/(manager)/notifications" },
  { icon: "newspaper-outline", label: "News feed", route: "/(manager)/newsfeed" },
  { icon: "cart-outline", label: "Marketplace", route: "/(manager)/marketplace" },
  { icon: "navigate-outline", label: "Shipments", route: "/(manager)/shipments" },
  { icon: "map-outline", label: "Live tracking", route: "/(manager)/live-tracking" },
  { icon: "sparkles-outline", label: "AI Assistant", route: "/(manager)/ai-assistant" },
  { icon: "bar-chart-outline", label: "Reports", route: "/(manager)/reports" },
  { icon: "business-outline", label: "Departments", route: "/(manager)/departments" },
  { icon: "help-circle-outline", label: "Help & support", route: "/(manager)/help" },
];

export default function ManagerSidebar({ visible, onClose }: { visible: boolean; onClose: () => void }) {
