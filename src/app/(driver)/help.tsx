...
const faqs = [
  { q: "Where do I see my assigned shipment?", a: "Tap My shipment on the home screen to see your current delivery, its route and cargo." },
  { q: "How do I update a delivery's status?", a: "Open My shipment and tap Update status. Mark it as departed, in transit or arrived as you go." },
  { q: "What if no shipment is assigned?", a: "The My shipment screen will say no active shipment. Your manager assigns deliveries to you." },
  { q: "How do I see notifications from my manager?", a: "Tap Notifications from the home screen or the menu to see all messages sent to you." },
  { q: "How do I update my profile or password?", a: "Tap your avatar → Edit profile, or Change password from the profile menu." },
];
